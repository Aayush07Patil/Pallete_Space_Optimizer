...
def visualize_separate_containers_with_plotly(containers, placed_products):
    ...
    for container in containers:
        ...
        # Define vertices (updated based on given logic)
        vertices = np.array([
            [0, W_offset, 0], [0, W_offset + WX, 0], [0, 0, H-HX], [0, 0, H],  
            [0, W, H], [0, W, H-HX], [L, W_offset, 0], [L, W_offset + WX, 0], 
            [L, 0, H-HX], [L, 0, H], [L, W, H], [L, W, H-HX]
        ])
